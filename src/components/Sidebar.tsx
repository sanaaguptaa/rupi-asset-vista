...
export function Sidebar() {
  ...
  const handleAddAsset = async () => {
    try {
      // Generate a temporary asset_id - this is just for TypeScript
      // The actual asset_id will be generated by the database trigger
      const tempAssetId = `TEMP_${Date.now()}`;
      
      // Create the asset data with all required fields including the required asset_id field
      const assetData = {
        asset_id: tempAssetId, // This will be overwritten by the database trigger
        asset_name: newAsset.asset_name,
        asset_class: newAsset.asset_type, // Using asset_type as asset_class for simplicity
        asset_type: newAsset.asset_type,
        department: newAsset.department,
        location: newAsset.location,
        purchase_date: newAsset.purchase_date,
        purchase_value: newAsset.purchase_value,
        verified_amount: newAsset.verified_amount,
      ...
      // The database trigger will replace our temporary asset_id with the correct one
        ...
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="verified_amount">Verified Amount (₹)</Label>
                <Input 
                  id="verified_amount" 
                  name="verified_amount" 
                  type="number" 
                  value={newAsset.verified_amount.toString()} 
                  onChange={handleInputChange} 
