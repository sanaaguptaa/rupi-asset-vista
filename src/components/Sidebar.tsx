...
export function Sidebar() {
  ...
  const handleAddAsset = async () => {
    try {
      // Create the asset data with all required fields
      // The asset_id will be generated by a database trigger
      const assetData = {
      ...
      // The asset_id will be auto-generated by the database trigger we set up
